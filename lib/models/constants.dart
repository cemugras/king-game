class Constants{
  ...
  static String APPBAR_MENU_EN = "King Score Table";
  static String APPBAR_MENU_TR = "King Skor Tablosu";
  static String APPBAR_NEWGAME_EN = "New Game";
  static String APPBAR_NEWGAME_TR = "Yeni Oyun";
  static String APPBAR_LASTGAME_EN = "Last Game";
  static String APPBAR_LASTGAME_TR = "Son Oyun";
  static String APPBAR_RULES_EN = "Rules";
  static String APPBAR_RULES_TR = "Kurallar";
  static String APPBAR_SETTINGS_EN = "Settings";
  ...
  static String CONTENT_NEWGAME_TITLE_TR = "Yeni Oyun";
  static String CONTENT_LASTGAME_TITLE_EN = "   Last Game";
  static String CONTENT_LASTGAME_TITLE_TR = "   Son Oyun";
  static String CONTENT_RULES_TITLE_EN = "   Rules";
  static String CONTENT_RULES_TITLE_TR = "   Kurallar";
  static String CONTENT_SETTINGS_TITLE_EN = "   Settings";
  static String CONTENT_SETTINGS_TITLE_TR = "   Ayarlar";
  static String CONTENT_NEWGAME_SUBTITLE_EN = "Create a game for King scores.";
  static String CONTENT_NEWGAME_SUBTITLE_TR = "King skoru için yeni oyun kur.";
  static String CONTENT_LASTGAME_SUBTITLE_EN = "   Last game information.";
  static String CONTENT_LASTGAME_SUBTITLE_TR = "   Son oynanan oyunun bilgileri.";
  static String CONTENT_RULES_SUBTITLE_EN = "   Game rule catalog.";
  static String CONTENT_RULES_SUBTITLE_TR = "   Kurallar kataloğu.";
  static String CONTENT_SETTINGS_SUBTITLE_EN = "   Configure settings.";
  ...
  static String CONTENT_END_GAME_EN = "Game is ended..";
  static String CONTENT_END_GAME_TR = "Oyun bitti..";
  static String CONTENT_DELETE_LAST_TURN_EN = "Last turn will be deleted.";
  static String CONTENT_DELETE_LAST_TURN_TR = "Son tur silinecek.";

  //Setting screen constants.
  static String CONTENT_LANG_TITLE_EN = "Language";
  static String CONTENT_LANG_TITLE_TR = "Dil";
  static String CONTENT_LANG_SUBTITLE_EN = "English";
  static String CONTENT_LANG_SUBTITLE_TR = "Türkçe";
  static String CONTENT_NIGHT_TITLE_EN = "Dark Mode";
  static String CONTENT_NIGHT_TITLE_TR = "Gece Modu";
  static String CONTENT_ENV_TITLE_TR = "Ortam";
  static String CONTENT_ENV_TITLE_EN = "Environment";
  static String CONTENT_ENV_SUBTITLE_TR = "Canlı";
  ...
  static String CONTENT_SETTINGS_SECTION_MISC_TR = "Diğer";
  static String CONTENT_SETTINGS_SECTION_MISC_EN = "Other";
